...
Describe the architecture of the program in the Ghidra project using aipiler_list_functions and aipiler_read_function_code, save it to ./ARCHITECTURE.md, it must be really precise and full of diagrams. If it helps, create a ./QUESTIONS.md file to add and answer questions related to the architecture.
